func approveToken(web3Instance: web3, fromAddress: String, contractAddress: String, spenderAddress: String, amount: String) {
    do {
        // 创建交易发起者地址对象
        ...
        let transaction = erc20Contract.write(
            "approve",
            parameters: [spender, value] as [AnyObject],
            extraData: Data(),
